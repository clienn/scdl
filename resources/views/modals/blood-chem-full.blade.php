<div class="modal fade" id="bloodChemFullModal" tabindex="-1" role="dialog" aria-labelledby="bloodChemFullModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-bold" id="psModalLabel">Blood Chem Full</h5>
      ...
      <div class="modal-body">
            <div class="row justify-content-between">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    @foreach($blood_chem_full as $item)
