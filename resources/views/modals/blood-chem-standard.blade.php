<div class="modal fade" id="bloodChemStandardModal" tabindex="-1" role="dialog" aria-labelledby="bloodChemStandardModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-bold" id="psModalLabel">Blood Chem Standard</h5>
      ...
      <div class="modal-body">
            <div class="row justify-content-between">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    @foreach($blood_chem_standard as $item)
