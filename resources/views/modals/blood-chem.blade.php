<div class="modal fade" id="bloodChemModal" tabindex="-1" role="dialog" aria-labelledby="bloodChemModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title font-bold" id="psModalLabel">Blood Chem</h5>
      ...
      <div class="modal-body">
            <div class="row justify-content-between">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-7">
                            <span class="font-10 font-black-2 font-bold">TPAG (Total Protein Albumin/Globulin Ratio):</span>
                        </div>
                    </div>

                    <div class="row mt-3"></div>

                    @foreach($blood_chem as $item)
                    <div class="row mt-2">
                        <div class="col-md-4">
